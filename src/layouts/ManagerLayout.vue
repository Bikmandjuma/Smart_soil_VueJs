<template>
  <div :class="['flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light']">
    ...
    <!-- Sidebar -->
    <aside class="flex-shrink-0 hidden w-64 bg-teal-900 border-r dark:border-primary-darker dark:bg-darker md:block">
      ...
      <header class="relative bg-white dark:bg-darker sticky top-0 z-50">
        <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
          ...
          <div class="flex">
            ...
            &nbsp;&nbsp;<router-link to="#" class="inline-block mt-1 text-2xl font-bold tracking-wider bg-gradient-to-b from-green-900 to-gray-800 bg-clip-text text-transparent" style="font-family: sa;">Soil_Smart</router-link>
          </div>
          <!-- <div>
            <form action="#">
